package com.example.packyourback.Constants;

public class MyConstants {

    public static final String My_SELECTION = "My Selection";
    ...
    public static final String BEACH_SUPPLY_CAMEL_CASE = "Beach Supplies";
    ...
    public static final String MY_SELECTION_CAMEL_CASE = "My Selections";
